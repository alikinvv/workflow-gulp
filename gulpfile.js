...
gulp.task('dev', gulp.series(gulp.parallel('html', 'css:build', 'js:dev'), gulp.parallel('watch', 'server')));
gulp.task('build', gulp.series(gulp.parallel('html', 'css:build', 'css:libs', 'js:build', 'img:build', 'fonts:build', 'svg')));
